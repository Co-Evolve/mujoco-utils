...
https://raw.githubusercontent.com/Farama-Foundation/Gymnasium/main/gymnasium/envs/mujoco/mujoco_rendering.py
This will only be used until this version is ported as a Gymnasium release.
"""
...
class MujocoRenderer:
    ...
    def render(
        ...
        Args:
            ...
            camera_name: The string name of the camera from which to render the frame in the MuJoCo simulation. This
            argument should not be passed if using cameara_id instead and vice versa

        Returns:
            If render_mode is "rgb_array" or "depth_arra" it returns a numpy array in the specified format. "human"
            render mode does not return anything.
        """
