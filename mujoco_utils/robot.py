...
from fprs.robot import Morphology, Robot
from fprs.specification import MorphologySpecification, RobotSpecification
...
class MJCRobot(Robot, ABC):
    ...
    def _build_morphology(
        ...
        return super()._build_morphology()


class MJCMorphology(Morphology, composer.Entity, ABC):
    def __init__(
            self,
